...
<head>
  ...
  <title>Withdraw | Bank of Expanders</title>
  ...
  <link rel="stylesheet" href="Assets/AdminLTE/plugins/colorpicker/bootstrap-colorpicker.min.css">
    ...
    <section class="content">
      ...
      <div class ="col-md-3">
        ...
        <div class="col-md-6">
          ...
          <h1>Your Withdraw QR Code</h2>


          <br>
<?php
$amount = $_POST['amount'];
$url = 'http://23.94.68.76/QR/index.php/588d4d601756fc834d903dc6/'.$amount;
$QR_url = 'https://api.qrserver.com/v1/create-qr-code/?size=200x200&data='.$url;
 ?>
 <img src="<?php echo $QR_url?>" alt="">


<hr>

<h3>Instructions for withdrawing online</h3>

1. Go to nearest local BOE branch. <a href="https://www.google.com/maps/search/capital+one/@38.9916432,-76.9692464,13z/data=!3m1!4b1">Google Maps</a><br>
2. Scan your unique QR code using the ATM Scanner<br>
3. Withdraw your money from security box<br>
            <div class="box-body">
...
<!-- bootstrap color picker -->
<script src="Assets/AdminLTE/plugins/colorpicker/bootstrap-colorpicker.min.js"></script>
<!-- bootstrap time picker -->
